...
public class Biblioteca {
    ...
    public Biblioteca() {
        this.materiais.add(new Livro("teste", "autor", Genero.FICCÃO));
    }
    ...
    public void adicionarLivro() {
        System.out.println("Por favor digite o título do livro que deseja adicionar.");
        String livro = scan.nextLine();
        System.out.println("Por favor digite o nome do autor do livro.");
        String autor = scan.nextLine();
        System.out.println("Por favor selecione o gênero do livro.");
